...
export default function Page({ params }) {
  ...
  const ITEMSDUMMY = [
    {
      id: 1,
      description: 'Bucket of Golden Bon Bons is a cool pfp apart of the golden collection',
      category: 'pfp',
    ...
    {
      id: 3,
      description: 'Epic Golden Cow is a cool pfp apart of the golden collection',
      category: 'pfp',
    ...
    {
      id: 4,
      description: 'Exclusive Boba of Liquid Gold is a cool pfp apart of the golden collection',
      category: 'pfp',
    ...
    {
      id: 5,
      description: 'Ghost spirit of Ghostliness is a cool pfp apart of the golden collection',
      category: 'pfp',
    ...
    {
      id: 6,
      description: 'Golden Bag of Traveling is a cool pfp apart of the golden collection',
      category: 'pfp',
    ...
    {
      id: 9,
      description: 'Golden Camera of Documentary is a cool pfp apart of the golden collection',
      category: 'pfp',
    ...
    {
      id: 11,
      description: 'Golden Duck of the Pond is a cool pfp apart of the golden collection',
      category: 'pfp',
    ...
    {
      id: 12,
      description: 'Golden Gadget of Games is a cool pfp apart of the golden collection',
      category: 'pfp',
    ...
    {
      id: 13,
      description: 'Golden Gas Mask is a cool pfp apart of the golden collection',
      category: 'pfp',
    ...
    {
      id: 14,
      description: 'Golden Gem of Power is a cool pfp apart of the golden collection',
      category: 'pfp',
    ...
    {
      id: 15,
      description: 'Golden Great Ball is a cool pfp apart of the golden collection',
      category: 'pfp',
    ...
    {
      id: 17,
      description: 'Golden Orb of Mystical Power is a cool pfp apart of the golden collection',
      category: 'pfp',
    ...
    {
      id: 18,
      description: 'Golden Peglin of Power is a cool pfp apart of the golden collection',
      category: 'pfp',
    ...
    {
      id: 19,
      description: 'Golden Penguin is a cool pfp apart of the golden collection',
      category: 'pfp',
    ...
    {
      id: 20,
      description: 'Golden Pinapple is a cool pfp apart of the golden collection',
      category: 'pfp',
    ...
    {
      id: 21,
      description: 'Golden Planet of Riches is a cool pfp apart of the golden collection',
      category: 'pfp',
    ...
    {
      id: 22,
      description: 'Golden Skull of Ancientness is a cool pfp apart of the golden collection',
      category: 'pfp',
    ...
    {
      id: 23,
      description: 'Golden Wool of Crocheting is a cool pfp apart of the golden collection',
      category: 'pfp',
    ...
    {
      id: 24,
      description: 'Legendary Guitar is a cool pfp apart of the golden collection',
      category: 'pfp',
    ...
    {
      id: 25,
      description: 'Legendary Moon Stick is a cool pfp apart of the golden collection',
      category: 'pfp',
    ...
    {
      id: 26,
      description: 'Rare King Squid of the Deep is a cool pfp apart of the golden collection',
      category: 'pfp',
    ...
    {
      id: 27,
      description: 'Ultra Rare Golden Potato is a cool pfp apart of the golden collection',
      category: 'pfp',
    ...
    {
      id: 28,
      description: 'Worlds First Light Bulb is a cool pfp apart of the golden collection',
      category: 'pfp',
