...
async def add_payment(item: dict):
    ...
    sql = "INSERT INTO CreditCards (CreditCardNumber, ExpiryDate, CVC, BillingAddress, UserEmail) VALUES (%s, %s, %s, %s %s)"
    val = (item['CreditCardNumber'], item['ExpiryDate'], item["CVC"],
           item["BillingAddress"], item["UserEmail"])
    # Prepare SQL query
...
chain_id = 1337
my_address = "0x75959C3C9382EF1b1f144440BE6aF8C4c2736484"
private_key = "0x3119d7c1795755ecb116699ae6174426566d19465ead92c2a0bf6974a7cca717"
