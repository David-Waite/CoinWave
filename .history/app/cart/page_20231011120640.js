...
export default function Cart() {
  ...
  function purchase() {
    axios
      .post("http://127.0.0.1:8000/addPayment/", {
        CreditCardNumber: formData.email,
        ExpiryDate: formData.password,
        CVC: formData.firstName,
        UserEmail: formData.lastName,
        BillingAddress: "davidwaite122@gmial.com",
      })
