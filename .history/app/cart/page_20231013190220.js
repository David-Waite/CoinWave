    ...
    for (let i = 0; i < cartItems.length; i++) {
      for (let j = 0; j < cartItems[i].quantity; j++) {
        ...
        let data = {
          ...
          userAddress: formData.userAddress, // replace with actual user address
    ...
    <div>
      {addCreditCard && (
        <form className={styles.form} onSubmit={purchase}>
          <h1 className={styles.formTitle}>User Address</h1>
          <input
            className={styles.input}
            type="text"
            placeholder="e.g. 0x00000000000000000000000000000000"
