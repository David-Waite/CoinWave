...
export default function Cart() {
  ...
  async function addToBlockchain() {
    ...
    const data = {
      ...
      itemPrice: 100, // replace with actual item price
      userAddress: "User Address", // replace with actual user address
    ...
    const item = {
      itemName: "test1",
      itemPrice: "69",
      userAddress: "0x425282C917fed31782d33E684A64078517AF9132",
      firstName: "David",
      lastName: "Waite",
