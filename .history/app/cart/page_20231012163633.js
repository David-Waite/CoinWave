...
export default function Cart() {
  ...
  async function fetchUserData() {
    ...
    try {
      const response = await axios.post("http://127.0.0.1:8000/users/me/", {
        headers: {
  ...
  async function checkForCreditCard(response) {
    let email = response.data[0].email;
    console.log(email);
    email.toString();

    axios
      .get("http://127.0.0.1:8000/hascreditcard/", email)
  ...
  async function addToBlockchain() {
    ...
    axios
      .post("http://127.0.0.1:8000/purchase/", item)
      .then(function (response) {
        console.log(response);
      })
  ...
  function purchase(event) {
    ...
    axios
      .post("http://127.0.0.1:8000/addpayment/", item)
      .then(function (response) {
        // setFormData({
        //   fullName: "",
        //   cardNumber: "",
