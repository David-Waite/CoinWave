...
export default function PurchaseHistroy() {
  const DUMMYHISTORY = [
    {
      id: 1,
      name: "example name;osdifjsd;oifjsdo;ifgjsd;ofigjsdo[fgijsdpoigfjsdopfgijsdopgijsdpofigjsdiofgjsdpofigjsdopfigjopixfpodijxpofijopjpozijfopijzfpoizjpfoiajfpdoaijdpofisajdfpoiajdfoiajdfpoasijdf",
      price: "0.25",
      Date: "12/11/2023",
    },
    {
